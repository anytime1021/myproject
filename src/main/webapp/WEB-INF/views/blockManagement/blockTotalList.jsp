        ...
        <div class="main-content">
            <div class="contents-container">
					...
					<div class="search-write">
						<div>
							<form class="search-box" method="get" action="${contextPath}/blockManagement/searchList.do">
								<input type="hidden" name="token" value="blockTotalList">
                        ...
                        <tbody>
							<c:forEach var="blockTotalList" items="${blockTotalList}">
								<tr>
									...
									<td>${blockTotalList.df_usage}</td>
									<td>${blockTotalList.df_itemStatus}</td>
				...
				<div class="paging-list">
					<ul class="pagination">
					    <li>
					        <a href="${contextPath}/blockManagement/blockTotalList.do?page=1">&lt;&lt; First</a>
					    </li>

					    <c:if test="${paging.startPage > 1}">
					        <fmt:formatNumber var="prevPage" value="${paging.startPage - 1}" type="number" maxFractionDigits="0" />
					        <li>
					            <a href="${contextPath}/blockManagement/blockTotalList.do?page=${prevPage}">&lt; Previous</a>
					        </li>
					    </c:if>
					    ...
					    <c:forEach var="i" begin="${paging.startPage}" end="${paging.endPage}">
					        <c:choose>
					            ...
					            <c:otherwise>
					                <li>
					                    <a href="${contextPath}/blockManagement/blockTotalList.do?page=${i}">${i}</a>
					                </li>
					            </c:otherwise>
					        </c:choose>
					    </c:forEach>
					    ...
					    <c:if test="${paging.endPage < paging.totalPage}">
					        ...
					        <li>
					            <a href="${contextPath}/blockManagement/blockTotalList.do?page=${nextPage}">Next &gt;</a>
					        </li>
					    </c:if>

					    <li>
					        <a href="${contextPath}/blockManagement/blockTotalList.do?page=${paging.totalPage}">Last &gt;&gt;</a>
					    </li>
					</ul>
            	</div>
        	</div>
