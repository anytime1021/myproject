					...
					<div class="work-rate">
						<table class="table-control-work">
							...
							<form name="addWorkReport" method="post" action="${contextPath}/report/addWorkReport.do">
								<c:forEach var="dailyReport" items="${dailyReport}">
								<c:set var="i" value="${i+1}" />
									<tr>
										<td style="width:4%;">${i}</td>
										<td style="width:14%;">${dailyReport.work_name}</td>
										<td style="width:7%;">${dailyReport.work_amount_RT}</td>
										<td style="width:7%;">${dailyReport.work_amount_PAUT}</td>
										<td style="width:7%;">${dailyReport.work_amount_TOFD}</td>
										<td style="width:7%;">${dailyReport.work_amount_UT}</td>
										<td style="width:7%;">${dailyReport.work_amount_MPT}</td>
										<td style="width:14%;">${dailyReport.work_manpower}</td>
										<td style="width:7%;">${dailyReport.work_xray}</td>
										<td style="width:7%;">${dailyReport.work_PAUT}</td>
										<td style="width:19%;">${dailyReport.work_charyang}</td>
									</tr>
								</c:forEach>
								<tr>
