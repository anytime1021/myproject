	...
	<%@ include file="../include/header.jsp"%>
    	<main class="first-container">
			...
			<div class="report-container">
						...
						<tbody>
							...
							<c:set var="i" value="${i+1}" />
								<tr>
									...
									<td><a href="${contextPath}/report/reportViewMixed.do?work_date=${reportListJsp.work_date}">${reportListJsp.board_title}</a></td>
				...
				<a class="btn" href="${contextPath}/report/addDailyReportFormMixed.do">작성하기</a>
			</div>
    	</main>
